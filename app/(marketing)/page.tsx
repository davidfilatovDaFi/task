...
export default function Home() {
  ...
  return (
    <main className="flex text-center px-10 min-h-screen flex-col gap-5 items-center justify-center">
      <div className='flex items-center gap-2 bg-sky-400 p-3 md:p-5 rounded-full text-sky-900 shadow-md'>
        <ClipboardCheck className='w-7 h-7'/>
        <span className='text-[16px] md:text-[20px] font-[700] uppercase'>best task managment</span>
      </div>
      <h1 className='text-[24px] md:text-[36px] font-[700]'>
        Taskfull helps team move
      </h1>
      <div className='text-[24px] md:text-[32px] font-[700] bg-gradient-to-r from-sky-500 to-pink-400 text-white p-3 rounded-xl'>
        work forward
      </div>
